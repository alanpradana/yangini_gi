  ...
  <div class="container">
    ...
    <div class="card o-hidden border-0 shadow-lg my-5">
      <div class="card-body p-0">
        ...
        <div class="row">
        <img src="<?=base_url('assets/img/02.png') ?>" class="img-fluid" alt="..." width="400px">
          <div class="col-lg-7">
            <div class="p-5">
              ...
              <form class="user" method="POST" action="<?= base_url('welcome/register')?>">
                <div class="form-group row">
                  <div class="col-sm-12">
                    <input type="text" name="Full_name"  class="form-control form-control-user" id="exampleFirstName" placeholder="Nama">
                  </div>
                </div>
